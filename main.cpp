...
int main()
{
    ...
    Texture t1, t2;
    t1.loadFromFile("C:/Users/user/Desktop/tiles-guide.png");
    t2.loadFromFile("C:/Users/user/Desktop/background.png");
    ...
    ////load from file////
    std::fstream myfile("C:/Users/user/Desktop/map.txt");
    for (int y = 0; y < 18; y++)
        for (int x = 0; x < 30; x++)
        {
            char a;  myfile >> a;
