...
int main()
{
    ...
    Texture t1, t2;
    t1.loadFromFile("C:/Users/Piicharpa/16_Games/16_Games/12 Mahjong Solitaire/files/tiles.png");
    t2.loadFromFile("C:/Users/Piicharpa/16_Games/16_Games/12 Mahjong Solitaire/files/background.png");
    ...
    ////load from file////
    std::fstream myfile("C:/Users/Piicharpa/16_Games/16_Games/12 Mahjong Solitaire/files/map.txt");
    for (int y = 0; y < 18; y++)
        for (int x = 0; x < 30; x++)
        {
            char a;  myfile >> a;
